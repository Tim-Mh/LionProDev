...
<div class="projects-mqF">
    <div class="auto-group-tbsj-hD7">
        <div class="auto-group-stdf-yRX">
            <div class="auto-group-da85-TrV">
                <div class="frame-10-ntm">
                    ...
                    <a href="{{ route('projects') }}" class="projects-CBo">PROJECTS</a>
                    <a href="{{ route('blogs') }}" class="blogs-uru">BLOGS</a>
                    <a href="{{ route('about') }}" class="about-2Rj">ABOUT</a>
                </div>
        ...
        <div class="auto-group-6xsj-g8u">
            ...
            <img class="portfolio1-1-5aM" src="./assets/portfolio1-1.png"/>
            <div class="frame-Cus">Video Testimonial</div>
            <div class="frame-Guj">Start your project</div>
            <p class="wahlbeck-sci-fi-audiobooks-xXf">Wahlbeck Sci-Fi Audiobooks</p>
        </div>
    </div>
    <div class="auto-group-bbxh-dth">
        <div class="auto-group-yudp-ZnM">
            ...
            <div class="frame-22-Kf3">
                <a href="{{ route('about') }}" class="about-us-dQq">About Us</a>
                <a href="{{ route('blogs') }}" class="blog-AQm">Blog</a>
