    ...
    <div class="auto-group-bd5p-XDo">
        <div class="auto-group-shwm-e3X">
            ...
            <div class="frame-22-QS1">
                <a href="{{ route('about') }}" class="about-us-vfF">About Us</a>
                <a href="{{ route('blogs') }}" class="blog-sKb">Blog</a>
                <a href="{{ route('terms') }}" class="terms-conditions-DeM">Terms &amp; Conditions</a>
                <a href="{{ route('privacy') }}" class="privacy-policy-AZb">Privacy Policy</a>
            </div>
