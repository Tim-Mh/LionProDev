                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <a href="<?php echo e(route('projects.index')); ?>" class="btn btn-secondary btn-sm">Back to Projects</a>
                            </div>
                        </div>
                        <div class="card-body">
...
<?php echo $__env->make('back-end.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\LionProDev\resources\views/back-end/projects/create.blade.php ENDPATH**/ ?>