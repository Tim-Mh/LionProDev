...
<div class="homepage2-mQZ">
    ...
    <div class="auto-group-2dux-AFP">
        ...
        <div class="frame-2oP">start a project</div>
        ...
        <div class="frame-10-6yb">
            <a style="text-decoration: none;" href="#" class="home-peh">HOME</a>
            <p class="projects-9S5">PROJECTS</p>
            <p class="blogs-54q">BLOGS</p>
            <p class="about-QN1">ABOUT</p>
        </div>
    ...
    <div class="auto-group-8ckw-qVF">
        <div class="auto-group-ttlz-hnM">
            ...
            <div class="frame-22-2CM">
                <p class="about-us-jsT">About Us</p>
                <p class="blog-sim">Blog</p>
                <p class="terms-conditions-25s">Terms &amp; Conditions</p>
                <p class="privacy-policy-xER">Privacy Policy</p>
            </div>
...
<?php /**PATH C:\laragon\www\LionProDev\resources\views/welcome.blade.php ENDPATH**/ ?>