        ...
        <div class="auto-group-stdf-yRX">
            <div class="auto-group-da85-TrV">
                <div class="frame-10-ntm">
                    ...
                    <a href="<?php echo e(route('projects')); ?>" class="projects-CBo">PROJECTS</a>
                    <a href="<?php echo e(route('blogs')); ?>" class="blogs-uru">BLOGS</a>
                    <a href="<?php echo e(route('about')); ?>" class="about-2Rj">ABOUT</a>
                </div>
    ...
    <div class="auto-group-bbxh-dth">
        <div class="auto-group-yudp-ZnM">
            ...
            <div class="frame-22-Kf3">
                <a href="<?php echo e(route('about')); ?>" class="about-us-dQq">About Us</a>
                <a href="<?php echo e(route('blogs')); ?>" class="blog-AQm">Blog</a>
...
<?php /**PATH C:\laragon\www\LionProDev\resources\views/front-end/projects/floater.blade.php ENDPATH**/ ?>